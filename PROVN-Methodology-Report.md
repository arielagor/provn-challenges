# PROVN AI Talent Draft — Honest Methodology
...
Claude turned that into a 200+ line plan file at `C:\Users\ariel\.claude\plans\i-ve-opened-a-cozy-pinwheel.md` covering folder structure, deliverable shapes per challenge, scoring weights, parallelism strategy, special data requirements, and hard rules. I read the plan, approved it, and let it run.
...
I'm fixing that with this version. The lesson: AI defaults to flattering the operator. If you want honesty about contribution, you have to explicitly ask for it.
